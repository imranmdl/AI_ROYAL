...
const CATEGORY_COLUMNS: Record<string, string[]> = {
  ...
  'Granite':    ['Category','Product Name','Brand','Finish Type','Height (Ft)','Width (Ft)','Purchase Rate Per Sqft','Transport Pct','Selling Price Per Sqft','Stock Slabs','Vendor Name','Order ID','Status'],
...
const SAMPLE_ROWS: Record<string, string[][]> = {
  ...
  'Granite':    [['Granite','GR_Galaxy_Black_6x2','Local Quarry','Double Polish','6','2','40','30','95','5','Karnataka Granite','ORD-001','Active']],
